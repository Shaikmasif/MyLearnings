...
<html lang="en">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="name" class="form-control" id="productName" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="exampleInputProductDescription" class="form-label">Product Description</label>
    <textarea rows="4" cols="4" type="text" name="desc" class="form-control" id="productDescription" aria-describedby="emailHelp">
    </textarea>
  </div>
  <div class="mb-3">
